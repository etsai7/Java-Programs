...
//User has made it to the bottom
      printMap();
   ...
   */
   public static boolean canMove(String move){
      ...
      if(move.equals("a")){
         if((currentPositionX-1>=0)&&(spots[currentPositionY][currentPositionX-1].getName().equals(" ") || spots[currentPositionY][currentPositionX-1].getName().equals("."))){
            return true;
         }
      }
      if(move.equals("s")){
      ...
      if(move.equals("d")){
         if((currentPositionX+1<columns)&&(spots[currentPositionY][currentPositionX+1].getName().equals(" ") || spots[currentPositionY][currentPositionX+1].getName().equals("."))){
            return true;
         }
      }
      return false;
